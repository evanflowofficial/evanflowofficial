...
export default function InstagramEmbed({ url, caption }: InstagramEmbedProps) {
    ...
    return (
      <div className="flex justify-center">
        <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6 text-center">
          <p className="text-white mb-4">Unable to load Instagram post</p>
          <a 
            href={url} 
            target="_blank" 
  ...
  return (
    <div className="flex justify-center relative">
      ...
      <div ref={embedRef} className={isLoading ? 'opacity-0' : 'opacity-100 transition-opacity duration-500'}>
        <blockquote
        ...
        >
          ...
          <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: '0', marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            <a href={url} style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }}>
              {caption || 'A post shared by Evan Flow (@evanflowmusic)'}
            </a>
          </p>
        </blockquote>
      </div>
