          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
            ...
            <div className="flex justify-center">
              <blockquote
                ...
                data-instgrm-permalink="https://www.instagram.com/reel/DO8nPjcAJ8g/"
              ...
              >
                ...
                <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: '0', marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                  <a href="https://www.instagram.com/reel/DO8nPjcAJ8g/" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }}>
                    A post shared by Evan Flow (@evanflowmusic)
                  </a>
                </p>
              </blockquote>
            </div>
